...
var currentDate = new Date(String(monthNum) + ',' + String(todaysDate) + ',' + String(yearNum));
...
{ 
  ...
  for (var i = firstDay; i < 8; i++){
	if(day == currentDay && yearNum == currentYear && monthNum == currentMonth)
	{
        calendarString += '<TD id =' + day + ' onclick = "current_date(' + day + ');" bgcolor=#FFFFFF ALIGN=left HEIGHT=50 WIDTH=100>&nbsp&nbsp' + day + '</TD>'
	}
	else
	{
